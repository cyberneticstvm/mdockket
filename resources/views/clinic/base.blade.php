...
<head>
    ...
    <!-- Title -->
	<title>Dockket - Homecare Booking App</title>
...
<div class="page-wraper">
    ...
    <div class="sidebar">
		...
		<ul class="nav navbar-nav">	
			...
			<li><a class="nav-link" href="/clinic/profile">
				<span class="dz-icon">
	...
	<div class="menubar-area">
		<div class="toolbar-inner menubar-nav">
            <a href="/clinic/services" class="nav-link {{ (request()->segment(2) == 'services') ? 'active' : '' }}">
            ...
            <a href="/clinic/reports" class="nav-link {{ (request()->segment(2) == 'reports') ? 'active' : '' }}">
